...
/** AbShape custom shape
 * 
 * 
 */
typedef struct AbCust_s {
  void (*getBounds)(const struct AbCust_s *cust, const Vec2 *centerPos, Region *bounds);
  int (*check)(const struct AbCust_s *shape, const Vec2 *centerPos, const Vec2 *pixel);
  const Vec2 halfSize;
} AbCust;
...
/** As required by AbShape
 */
int abCustCheck(const AbCust *cust, const Vec2 *centerPos, const Vec2 *pixel);

/** AbShape alien shape
 * 
 * 
 */
typedef struct AbAlien_s {
  void (*getBounds)(const struct AbAlien_s *alien, const Vec2 *centerPos, Region *bounds);
  int (*check)(const struct AbAlien_s *shape, const Vec2 *centerPos, const Vec2 *pixel);
  const Vec2 halfSize;
} AbAlien;
...
/** As required by AbShape
 */
int abAlienCheck(const AbAlien *alien, const Vec2 *centerPos, const Vec2 *pixel);
